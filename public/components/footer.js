...
(function () {
    ...
    if (isMEP) {
        ...
        footerHTML = ''
            ...
            + '        <img src="' + logoPath + '" alt="Alavanka" class="footer-logo" width="84" height="32">'
            ...
            + '          <a href="https://www.linkedin.com/company/alavanka/" target="_blank" rel="noopener noreferrer">LinkedIn</a>'
